...
import framework.jimmy.com.framework.thread.Client;
import framework.jimmy.com.framework.thread.PostOffice;
import framework.jimmy.com.framework.thread.Simulator;
...
public class PostOfficeActivity extends AppCompatActivity implements Client.ClientCallback {
    ...
    public static class PostListAdapter extends RecyclerView.Adapter<PostListAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_list_post_office, parent, false);
